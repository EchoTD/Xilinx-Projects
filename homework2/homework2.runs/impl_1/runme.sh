...
HD_PWD='/home/acg/Desktop/Xilinx Projects/homework2/homework2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log parkingGate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source parkingGate.tcl -notrace
