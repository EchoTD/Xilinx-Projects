...
HD_PWD='/home/acg/Desktop/Xilinx Projects/homework2/homework2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parkingGate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parkingGate.tcl
