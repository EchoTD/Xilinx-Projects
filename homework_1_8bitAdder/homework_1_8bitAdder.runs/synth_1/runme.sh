...
HD_PWD='/home/acg/Desktop/Xilinx Projects/homework_1_8bitAdder/homework_1_8bitAdder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eightBitAdder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eightBitAdder.tcl
