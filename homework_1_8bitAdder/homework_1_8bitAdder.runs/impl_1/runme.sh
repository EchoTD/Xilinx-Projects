...
HD_PWD='/home/acg/Desktop/Xilinx Projects/homework_1_8bitAdder/homework_1_8bitAdder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eightBitAdder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eightBitAdder.tcl -notrace
